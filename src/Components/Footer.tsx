...
return  (
        <footer className="py-7 px-4 bg-card relative border-t border-border mt-12 pt-8 flex flex-wrap justify-center items-center">
            ...
            <a href="#hero" className="absolute bottom-50 md:bottom-30 right-12 md:right-10 flex gap-3 text-foreground bg-blue-950 .dark:bg-purple-950 px-2 py-3 rounded-full">
